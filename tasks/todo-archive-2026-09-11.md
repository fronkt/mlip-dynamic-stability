<!-- ARCHIVED 2026-09-11.
Provenance: this is the verbatim tasks/todo.md as it stood immediately before the
RSC Advances major-revision plan replaced it. It is the Aug-17 post-audit snapshot,
written when the paper was believed submission-ready for Digital Discovery.
It is SUPERSEDED and its "NEXT STEPS" are stale: the paper was submitted to DD
(DD-ART-07-2026-000468), transferred to RSC Advances (RA-ART-07-2026-006452),
and received a major-revision decision on 2026-09-11.
Kept for the audit trail; do not act on it. Current plan: tasks/todo.md -->
